                ...
                <div className="bg-slate-50 rounded-3xl p-6 border border-slate-100 space-y-6">
                  ...
                  <div>
                    <select 
                      ...
                      className="w-full bg-white border border-slate-200 p-4 rounded-2xl text-slate-700 text-sm focus:ring-2 focus:ring-indigo-500 outline-none transition cursor-pointer"
                    >
                  ...
                  {currentLogic && (
                    <div className="space-y-4 animate-in fade-in slide-in-from-top-2 duration-300">
                      ...
                      <div className="p-4 bg-indigo-50 rounded-2xl border border-indigo-200">
                        <label className="block text-[10px] font-bold text-indigo-600 uppercase tracking-widest mb-1">Rekomendasi Tindakan</label>
                        <p className="text-[10px] text-indigo-700 leading-relaxed font-bold italic whitespace-pre-line">{currentLogic.recommendation}</p>
                      </div>
                    </div>
                  )}
                </div>
