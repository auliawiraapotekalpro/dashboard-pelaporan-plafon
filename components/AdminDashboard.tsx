              ...
              <tbody className="divide-y divide-slate-50">
                {filteredReports.map((report) => (
                  <tr key={report.id} className="hover:bg-slate-50/50 transition duration-150 group">
                    ...
                    {/* Kolom rekomendasi lebar horizontal */}
                    <td className="px-6 py-8 min-w-[600px] max-w-[850px]">
                       <div className="text-[10px] font-black text-slate-700 leading-relaxed max-h-[160px] overflow-y-auto pr-2 whitespace-pre-line custom-scrollbar">
                    ...
                    <td className="px-6 py-8">
                       <div className="flex items-center gap-3 min-w-[320px]">
                          ...
                          >
                             <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7H5a2 2 0 00-2 2v12a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-3m-1 4l-3 3m0 0l-3-3m3 3V4" /></svg>
                             SUBMIT
                          </button>
